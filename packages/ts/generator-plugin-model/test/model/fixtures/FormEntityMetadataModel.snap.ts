...
const FormEntityMetadataModel = m
  ...
  .property("withAnnotationAttributes", m.meta(NumberModel, { annotations: [{ jvmType: "jakarta.persistence.ManyToMany", attributes: { fetch: "EAGER", targetEntity: { jvmType: "com.example.application.endpoints.TsFormEndpoint$FormEntity" }, cascade: ["PERSIST", "MERGE"] } }, { jvmType: "jakarta.persistence.Id" }] }))
  .build();
