...
function getAllUsers_1(init?: EndpointRequestInit_1): Promise<Subscription_1<UserEntity_1 | undefined> | undefined> { return client_1.subscribe("PushTypeEndpoint", "getAllUsers", {}); }
function getAllUsersNonnull_1(init?: EndpointRequestInit_1): Promise<Subscription_1<UserEntity_1>> { return client_1.subscribe("PushTypeEndpoint", "getAllUsersNonnull", {}); }
