...
function getThreeParams_1(__init: string, _init: string, init: string, ___init?: EndpointRequestInit_1): Promise<string> { return client_1.call("NameClashEndpoint", "getThreeParams", { __init, _init, init }, ___init); }
