...
async function unwrap_1(value: GenericTypesEntity_1<string | undefined>, init?: EndpointRequestInit_1): Promise<string> { return client_1.call("GenericTypesEndpoint", "unwrap", { value }, init); }
