...
function personSignal(options?: SignalMethodOptions<Person>): ValueSignal_1<Person> { return new ValueSignal_1(options?.defaultValue ?? PersonModel[$defaultValue], {
    client: client,
    endpoint: "ShadowedSignalService",
    method: "personSignal"
}); }
function otherPersonSignal(ValueSignal: string, options?: SignalMethodOptions<Person_1>): ValueSignal_1<Person_1> { return new ValueSignal_1(options?.defaultValue ?? PersonModel_1[$defaultValue], {
    client: client,
    endpoint: "ShadowedSignalService",
