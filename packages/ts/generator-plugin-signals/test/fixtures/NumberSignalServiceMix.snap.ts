...
function counter_1(): NumberSignal_1 {
    return new NumberSignal_1(0, { client: client_1, endpoint: "NumberSignalService", method: "counter" });
}
...
function sharedValue_1(highOrLow: boolean, date: string | undefined): NumberSignal_1 {
    return new NumberSignal_1(0, { client: client_1, endpoint: "NumberSignalService", method: "sharedValue", params: { highOrLow, date } });
}
