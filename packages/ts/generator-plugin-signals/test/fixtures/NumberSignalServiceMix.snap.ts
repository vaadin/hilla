...
function counter_1() {
    return new NumberSignal_1(null, { client: client_1, endpoint: "NumberSignalService", method: "counter" });
}
...
function sharedValue_1() {
    return new NumberSignal_1(null, { client: client_1, endpoint: "NumberSignalService", method: "sharedValue" });
}
