...
import resolveNodeESM from '@hilla/generator-typescript-utils/resolveNodeESM.js';
...
export default class GeneratorIO {
  ...
  async loadPlugin(modulePath: string): Promise<PluginConstructor> {
    ...
    const module: PluginConstructorModule = await import(resolveNodeESM(modulePath, import.meta));
