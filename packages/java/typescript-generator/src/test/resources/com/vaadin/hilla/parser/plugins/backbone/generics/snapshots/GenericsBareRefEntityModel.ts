...
class GenericsBareRefEntityModel<T extends GenericsBareRefEntity = GenericsBareRefEntity> extends ObjectModel<T> {
  ...
  get bareGenericTypeProperty(): ObjectModel {
    return this[_getPropertyModel]('bareGenericTypeProperty', (parent, key) =>
      new ObjectModel(parent, key, true));
  }

  get bareRefEntityProperty(): GenericsBareRefEntityModel_1 {
    return this[_getPropertyModel]('bareRefEntityProperty', (parent, key) =>
      new GenericsBareRefEntityModel_1(parent, key, true));
  }
}
