import { BooleanModel, StringModel, _getPropertyModel, makeObjectEmptyValueCreator } from '@vaadin/hilla-lit-form';
...
class DeleteEventModel<T extends DeleteEvent = DeleteEvent> extends BaseEventModel<T> {
  ...
  get item(): StringModel {
    return this[_getPropertyModel]('item', (parent, key) =>
      new StringModel(parent, key, true, { meta: { javaType: 'java.lang.String' } }));
  }

  get force(): BooleanModel {
    return this[_getPropertyModel]('force', (parent, key) =>
