...
import type Person from "./com/vaadin/hilla/parser/plugins/backbone/superclassmethods/PersonEndpoint/Person.js";
...
async function delete_1(id: number | undefined, init?: EndpointRequestInit): Promise<void> { return client.call("PersonEndpoint", "delete", { id }, init); }
...
export { delete_1 as delete, get, getNonNullablePage, getPage, size, update };
