...
class NullableFieldModelModel<T extends NullableFieldModel = NullableFieldModel> extends ObjectModel<T> {
  ...
  get jakartaNonnull(): StringModel {
    return this[_getPropertyModel]('jakartaNonnull', (parent, key) =>
      new StringModel(parent, key, false, { meta: { javaType: 'java.lang.String' } }));
  }

  get jspecifyNonnull(): StringModel {
    return this[_getPropertyModel]('jspecifyNonnull', (parent, key) =>
      new StringModel(parent, key, false, { meta: { javaType: 'java.lang.String' } }));
  }

  get springNonnull(): StringModel {
    return this[_getPropertyModel]('springNonnull', (parent, key) =>
      new StringModel(parent, key, false, { meta: { javaType: 'java.lang.String' } }));
  }
}
