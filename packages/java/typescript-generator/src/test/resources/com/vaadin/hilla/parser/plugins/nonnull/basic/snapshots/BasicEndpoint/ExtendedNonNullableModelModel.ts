import { ArrayModel, StringModel, _getPropertyModel, makeObjectEmptyValueCreator } from '@vaadin/hilla-lit-form';
...
class ExtendedNonNullableModelModel<T extends ExtendedNonNullableModel = ExtendedNonNullableModel> extends NonNullableModelModel<T> {
  ...
  get mixedAnnotations(): ArrayModel<StringModel> {
    return this[_getPropertyModel]('mixedAnnotations', (parent, key) =>
  ...
  get nonTypeAnnotation(): StringModel {
    return this[_getPropertyModel]('nonTypeAnnotation', (parent, key) =>
