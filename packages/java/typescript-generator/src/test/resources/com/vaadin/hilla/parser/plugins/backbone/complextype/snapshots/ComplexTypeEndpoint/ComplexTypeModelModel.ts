import { ArrayModel, ObjectModel, _getPropertyModel, makeObjectEmptyValueCreator } from '@vaadin/hilla-lit-form';
...
class ComplexTypeModelModel<T extends ComplexTypeModel = ComplexTypeModel> extends ObjectModel<T> {
  ...
  get complexList(): ArrayModel<ObjectModel<Record<string, ReadonlyArray<string | undefined> | undefined>>> {
    return this[_getPropertyModel]('complexList', (parent, key) =>
      new ArrayModel(parent, key, true,
        (parent, key) => new ObjectModel(parent, key, true, { meta: { javaType: 'java.util.Map' } }),
        { meta: { javaType: 'java.util.List' } }));
  }

  get complexMap(): ObjectModel<Record<string, ReadonlyArray<string | undefined> | undefined>> {
    return this[_getPropertyModel]('complexMap', (parent, key) =>
