...
class PageableModel<T extends Pageable = Pageable> extends ObjectModel<T> {
  ...
  get pageNumber(): NumberModel {
    return this[_getPropertyModel]('pageNumber', (parent, key) =>
      new NumberModel(parent, key, false, { meta: { javaType: 'int' } }));
  }

  get pageSize(): NumberModel {
    return this[_getPropertyModel]('pageSize', (parent, key) =>
      new NumberModel(parent, key, false, { meta: { javaType: 'int' } }));
  }

  get sort(): SortModel {
    return this[_getPropertyModel]('sort', (parent, key) =>
      new SortModel(parent, key, false));
  }
}
