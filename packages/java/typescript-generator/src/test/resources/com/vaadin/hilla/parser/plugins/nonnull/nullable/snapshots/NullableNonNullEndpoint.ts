...
export async function nullableNonNullFieldModel(
  nullableNonNullFieldModel: NullableNonNullFieldModel,
  init?: EndpointRequestInit,
): Promise<NullableNonNullFieldModel> {
  return client.call('NullableNonNullEndpoint', 'nullableNonNullFieldModel', { nullableNonNullFieldModel }, init);
}
