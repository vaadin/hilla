import { ArrayModel, _getPropertyModel, makeObjectEmptyValueCreator } from '@vaadin/hilla-lit-form';
...
class TeamModel<T extends Team = Team> extends AbstractEntityModel<T> {
  ...
  get employees(): ArrayModel<EmployeeModel> {
    return this[_getPropertyModel]('employees', (parent, key) =>
  ...
  get manager(): ManagerModel {
    return this[_getPropertyModel]('manager', (parent, key) =>
      new ManagerModel(parent, key, true));
  }
}
