...
class OrderModel<T extends Order = Order> extends ObjectModel<T> {
  ...
  get direction(): DirectionModel {
    return this[_getPropertyModel]('direction', (parent, key) =>
      new DirectionModel(parent, key, false));
  }

  get property(): StringModel {
    return this[_getPropertyModel]('property', (parent, key) =>
      new StringModel(parent, key, false, { validators: [new NotBlank()], meta: { javaType: 'java.lang.String' } }));
  }

  get ignoreCase(): BooleanModel {
    return this[_getPropertyModel]('ignoreCase', (parent, key) =>
      new BooleanModel(parent, key, false, { meta: { javaType: 'boolean' } }));
  }

  get nullHandling(): NullHandlingModel {
    return this[_getPropertyModel]('nullHandling', (parent, key) =>
      new NullHandlingModel(parent, key, true));
  }
}
