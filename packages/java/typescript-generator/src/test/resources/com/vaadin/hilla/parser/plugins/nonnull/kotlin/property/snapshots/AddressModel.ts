import { NumberModel, StringModel, _getPropertyModel, makeObjectEmptyValueCreator } from '@vaadin/hilla-lit-form';
...
class AddressModel<T extends Address = Address> extends AbstractEntityModel<T> {
  ...
  get street(): StringModel {
    return this[_getPropertyModel]('street', (parent, key) =>
      new StringModel(parent, key, false, { meta: { javaType: 'java.lang.String' } }));
  }

  get zipCode(): StringModel {
    return this[_getPropertyModel]('zipCode', (parent, key) =>
      new StringModel(parent, key, false, { meta: { javaType: 'java.lang.String' } }));
  }

  get city(): StringModel {
    return this[_getPropertyModel]('city', (parent, key) =>
