...
async function delete_1(id: number, init?: EndpointRequestInit): Promise<void> { return client.call("PersonEndpoint", "delete", { id }, init); }
...
export { create, delete_1 as delete, get, getNonNullablePage, getPage, save, size, update };
