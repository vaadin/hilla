...
export async function getBar(init?: EndpointRequestInit): Promise<string | undefined> {
  return client.call('MultiEndpointsBarEndpoint', 'getBar', {}, init);
}

export async function getShared(init?: EndpointRequestInit): Promise<MultiEndpointsSharedModel | undefined> {
  return client.call('MultiEndpointsBarEndpoint', 'getShared', {}, init);
}
