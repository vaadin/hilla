...
public class MultiEndpointsTest extends AbstractFullStackTest {
    @Test
    public void should_GenerateOneFilePerEndpoint() {
        assertTypescriptMatchesSnapshot(MultiEndpointsBarEndpoint.class,
