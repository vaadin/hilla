 ...
 * <p>
 * These utilities normalize whitespace, line endings, and other formatting
 * differences to focus on semantic equality.
 */
public class TypeScriptAssertions {
     ...
     * <p>
     * Normalizes whitespace, line endings, and formatting before comparison to
    ...
    /**
     * Asserts that generated TypeScript matches expected TypeScript, with a
     ...
     *            expected TypeScript code
     */
    public static void assertTypeScriptEquals(String fileName, String actual,
            String expected) {
        try {
     ...
     * <p>
     * This includes: - Normalizing line endings to \n - Removing trailing
     * whitespace - Normalizing multiple blank lines to double newlines -
     * Trimming leading/trailing whitespace
     *
     * @param typescript
     *            TypeScript code to normalize
            ...
            if (!expectedLine.equals(actualLine)) {
                ...
                if (diffCount >= 10) {
                    diff.append(String.format("... and %d more differences\n",
                            countRemainingDifferences(expectedLines,
                                    actualLines, i + 1)));
                    break;
                }
            }
    ...
    private static int countRemainingDifferences(String[] expectedLines,
            String[] actualLines, int startFrom) {
        var count = 0;
        var maxLines = Math.max(expectedLines.length, actualLines.length);
