...
import com.vaadin.hilla.typescript.parser.core.ParserException;
import com.vaadin.hilla.typescript.parser.core.basic.Endpoint;
...
public class EndpointExposedAndSecurityAnnotationTest {
    ...
    public void throws_when_parentEndpointClass_annotatedWithSecurityAnnotations() {
        ...
        assertTrue(exception.getMessage().startsWith(
                "Class `" + ParentEndpoint.class.getName() + "` is annotated with `" + EndpointExposed.class.getName() + "` and `jakarta.annotation.security.RolesAllowed` annotation."));
