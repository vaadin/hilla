...
public class EndpointControllerTest {
    ...
    public void should_Return404_When_IllegalAccessToMethodIsPerformed() {
        ...
        when(restrictingCheckerMock.check(any(Method.class), any(),
                any())).thenReturn(accessErrorMessage);
        ...
        verify(restrictingCheckerMock).check(Mockito.any(Method.class), Mockito.any(),
                Mockito.any());
        Mockito.verifyNoMoreInteractions(restrictingCheckerMock);
        verify(restrictingCheckerMock, times(1)).check(Mockito.any(Method.class),
