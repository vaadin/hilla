...
function _getModel(endpointRequestInit?: EndpointRequestInit): Promise<Model | undefined> {
  return client.call('ComplexHierarchyEndpoint', 'getModel', {} , endpointRequestInit);
}
