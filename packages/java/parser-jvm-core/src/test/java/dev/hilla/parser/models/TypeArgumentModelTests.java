...
public class TypeArgumentModelTests {
    ...
    static final class Context
        ...
        private static final Map<String, AnnotatedType> reflectionOrigins = getDeclaredFields(Sample.class)
        ...
        Context(ScanResult source) {
            super(source, reflectionOrigins, getDeclaredFields(Sample.class, source)
