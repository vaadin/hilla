...
import static com.vaadin.hilla.parser.test.helpers.ClassMemberUtils.toGetterName;
import static com.vaadin.hilla.parser.test.helpers.ClassMemberUtils.toSetterName;
...
public class JacksonPropertyModelTests {
    ...
    public void should_ProvidePropertyAnnotations(JacksonPropertyModel model,
        ...
        case "privatePropertyWithAccessors" -> Set.of(
                "com.vaadin.hilla.parser.models.jackson.JacksonPropertySharedTests$FieldAnnotation",
                "com.vaadin.hilla.parser.models.jackson.JacksonPropertySharedTests$MethodAnnotation",
                "com.vaadin.hilla.parser.models.jackson.JacksonPropertySharedTests$ParameterAnnotation");
