...
function _getAccounts(endpointRequestInit?: EndpointRequestInit): Promise<Array<Account | undefined> | undefined> {
  return client.call('ComplexReturnTypeEndpoint', 'getAccounts', {}, endpointRequestInit);
}
