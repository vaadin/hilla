...
@NpmPackage(value = "@hilla/generator-typescript-core", version = "1.2.0-alpha1")
@NpmPackage(value = "@hilla/generator-typescript-utils", version = "1.2.0-alpha1")
@NpmPackage(value = "@hilla/generator-typescript-cli", version = "1.2.0-alpha1")
@NpmPackage(value = "@hilla/generator-typescript-plugin-client", version = "1.2.0-alpha1")
@NpmPackage(value = "@hilla/generator-typescript-plugin-backbone", version = "1.2.0-alpha1")
