...
abstract class AbstractGradleTest {
    ...
    val hillaVersion = System.getenv("hilla.version").takeUnless { it.isNullOrEmpty() } ?: "24.10-SNAPSHOT"
    val flowVersion = System.getenv("flow.version").takeUnless { it.isNullOrEmpty() } ?: "24.10-SNAPSHOT"
    /**
