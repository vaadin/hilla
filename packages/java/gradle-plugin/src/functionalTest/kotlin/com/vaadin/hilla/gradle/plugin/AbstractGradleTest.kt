...
abstract class AbstractGradleTest {
    ...
    val hillaVersion = System.getenv("hilla.version").takeUnless { it.isNullOrEmpty() } ?: "24.9-SNAPSHOT"
    val flowVersion = System.getenv("flow.version").takeUnless { it.isNullOrEmpty() } ?: "24.9-SNAPSHOT"
    /**
