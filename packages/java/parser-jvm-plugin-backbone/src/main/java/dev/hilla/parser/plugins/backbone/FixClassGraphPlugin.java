...
/**
 * Implements a workaround for the <a
 * href="https://github.com/classgraph/classgraph/issues/706">ClassGraph’s
 * {@code TypeVariable.resolve()} issue</a>. Processes type signatures to
 * find type variables, then manually resolves them to find respective type
...
public class FixClassGraphPlugin extends AbstractPlugin<PluginConfiguration> {
     ...
     * its type arguments.
     *
     * @param classRef The class reference to process.
     * @param path The context path for type parameter lookup.
     ...
     *
     * @param typeArgument The type argument to process.
     * @param path The context path for type parameter lookup.
     ...
     *
     * @param signature The type signature to process.
     * @param path The context path for type parameter lookup.
     ...
     *
     * @param typeVariable The type variable to process.
     * @param path The context path for type parameter lookup.
