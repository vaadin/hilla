...
public class ShadowedNameEndpoint {
    ...
    public dev.hilla.parser.plugins.backbone.shadowedname.subpackage.Collection<String> getSeparateUserDefinedCollection() {
        return new dev.hilla.parser.plugins.backbone.shadowedname.subpackage.Collection<>();
    }
