...
@NpmPackage(value = "@hilla/generator-typescript-core", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-utils", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-cli", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-plugin-client", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-plugin-backbone", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-plugin-barrel", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-plugin-model", version = "1.2.13")
@NpmPackage(value = "@hilla/generator-typescript-plugin-push", version = "1.2.13")
